...
- поддерживает backup, restore, миграции и журнал действий.
...
Лента новостей, категории, источники, ручные новости, реакции, запуск агрегации.

```text
backend/app/api/admin.py
```

Админские функции: пользователи, роли, логи, backup, restore, миграции.
